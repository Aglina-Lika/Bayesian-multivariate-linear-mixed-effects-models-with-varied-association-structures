...
for (i in 1:200){
  ...
  fit <- stan(file = "Area and Value//STAN codes//funcForm_v&a_assoc_D1D2_no_assoc_D1D2.stan", 
  ...
  summary1 = as.data.frame(summary(fit, 
                                   pars = c("temp_betas1","temp_betas2","sigma1","sigma2","D_1","D_2"))$summary)
  
  
  save(summary1, file = paste0("Area and Value//V_A_assoc_D1D2_no_assoc_D1D2//summary_", i, ".RData"))
}
