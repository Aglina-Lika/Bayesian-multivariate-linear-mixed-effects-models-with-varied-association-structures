...
filenames = as.list(dir(path = "Area and Value//V_A_D_D", pattern="summary_*"))
...
df_summary = data.frame(matrix(vector(), 200, 61,
...
for (i in 1:200){
    ...
    df_summary[i,]$mean_D11 = tmp_df[11,]$mean
    df_summary[i,]$n_eff_D11 = tmp_df[11,]$n_eff
    df_summary[i,]$Rhat_D11 = tmp_df[11,]$Rhat
    
    df_summary[i,]$mean_D12 = tmp_df[12,]$mean
    df_summary[i,]$n_eff_D12 = tmp_df[12,]$n_eff
    df_summary[i,]$Rhat_D12 = tmp_df[12,]$Rhat
    
    
    df_summary[i,]$mean_D13 = tmp_df[13,]$mean
    df_summary[i,]$n_eff_D13 = tmp_df[13,]$n_eff
    df_summary[i,]$Rhat_D13 = tmp_df[13,]$Rhat
    
    df_summary[i,]$mean_D14 = tmp_df[14,]$mean
    df_summary[i,]$n_eff_D14 = tmp_df[14,]$n_eff
    df_summary[i,]$Rhat_D14 = tmp_df[14,]$Rhat
        
    df_summary[i,]$mean_D22 = tmp_df[16,]$mean
    df_summary[i,]$n_eff_D22 = tmp_df[16,]$n_eff
    df_summary[i,]$Rhat_D22 = tmp_df[16,]$Rhat
    
    df_summary[i,]$mean_D23 = tmp_df[17,]$mean
    df_summary[i,]$n_eff_D23 = tmp_df[17,]$n_eff
    df_summary[i,]$Rhat_D23 = tmp_df[17,]$Rhat
    
    
    df_summary[i,]$mean_D24 = tmp_df[18,]$mean
    df_summary[i,]$n_eff_D24 = tmp_df[18,]$n_eff
    df_summary[i,]$Rhat_D24 = tmp_df[18,]$Rhat
    
    df_summary[i,]$mean_D33 = tmp_df[21,]$mean
    df_summary[i,]$n_eff_D33 = tmp_df[21,]$n_eff
    df_summary[i,]$Rhat_D33 = tmp_df[21,]$Rhat
    
    df_summary[i,]$mean_D34 = tmp_df[22,]$mean
    df_summary[i,]$n_eff_D34 = tmp_df[22,]$n_eff
    df_summary[i,]$Rhat_D34 = tmp_df[22,]$Rhat
    
    df_summary[i,]$mean_D44 = tmp_df[26,]$mean
    df_summary[i,]$n_eff_D44 = tmp_df[26,]$n_eff
    df_summary[i,]$Rhat_D44 = tmp_df[26,]$Rhat
    
    }


save(df_summary,file="Area and Value//gathered_results//ALL_V_A_D_D.RData")
