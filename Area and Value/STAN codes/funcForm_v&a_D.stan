...
transformed parameters {
 ...
 //  unstandardized version of fA_derivY1
  for (j2 in 1:N2) {
    ...
    y2_hat[j2] = X2[j2, 1] * temp_betas2[1] + X2[j2, 2] * temp_betas2[2] + X2[j2, 3] * temp_betas2[3] + Z_2[j2,1] * b[id2[j2], RE_ind2[1]] + Z_2[j2,2] * b[id2[j2], RE_ind2[2]] + temp_alphaV * y1_m[j2]+ temp_alphaA * fA_derivY1_m[j2];
  }
